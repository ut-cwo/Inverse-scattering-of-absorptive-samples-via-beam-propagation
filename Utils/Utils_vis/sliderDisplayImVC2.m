%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         sliderDisplayImVC2.m                            %
% _______________________________________________________________________ %
%                     Interactable 3D slice viewer                        %
%                                                                         %
% This function creates plots for data, a multidimensional array.         %
% Sliders are created to navigate through data.                           %
%                                                                         %
% For example, let's assume data is 3D, containing images (in the first   %
% two dimensions) for different values of defocus (third dimension).      %
% sliderDisplay will display these images for a certain defocus value     %
% that can be changed with the slider.                                    %
%                                                                         %
% For first time use, sliderDisplay() with no parameter will              %
% automatically generate data to plot.                                    %
...
% to modify: "Values to change" in the beginning and "Here is what you    %
% want to display" in the very end.                                       %
%                                                                         %
...
%% sliderDisplayImVC2: Visualize 3D matrices
% Arguments:   
%   data        - 3D matrix 
%   cric        - Define circles
%   figMod      - String of figure commands
