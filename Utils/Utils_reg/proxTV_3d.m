...
%                   3D proximal TV with warm starting                     %
%                                                                         %
% A modified implementation of proximal 3D TV regularization as described %
% by Beck and Teboulle [4] adding a warm starting criterion and           %
% performing minor adjustments for code performance with large gpuArrays. %
%                                                                         %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [u, dual] = proxTV_3d(x, gamma, numIters, warmStart, warmIts, dual)
%% proxTV_3d: Proximal operator for 3D isotropic TV
% Arguments:
